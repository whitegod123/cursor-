...
# ==================== 2 ====================
H(doc, "二、相关开源模型（按迁移优先级）", 1)
P(doc, "下表只列「能拿来改成螺杆泵井计产」的开源。与计产无关的（故障诊断、几何设计、资产管理）不列。")
...
H(doc, "3.4 具体操作清单（建议从第 1 项开源改起）", 2)
...
# ==================== 4 ====================
H(doc, "四、辅助工具（算泵压差时用，不是 NN 本身）", 1)
...
B(doc, "导出本井「泵参数 + 试井产量」对齐表，按 3.2 列好特征。", bold_prefix="本周：")
